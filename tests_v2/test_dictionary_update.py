...
from terim_etmeni_v2.dictionary_update import check_and_update, discover_pdf_url
...
class DictionaryUpdateTests(unittest.TestCase):
    ...
    def test_pdf_url_can_be_discovered_from_an_embed(self):
        ...
        with patch("terim_etmeni_v2.dictionary_update._request", return_value=html):
    ...
    def test_failed_remote_update_preserves_bootstrap(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch("terim_etmeni_v2.dictionary_update._request", side_effect=OSError("offline")):
