...
from terim_etmeni.abbreviation_pdf import convert_abbreviation_pdf
from terim_etmeni.dictionary_pdf import DictionaryImportError
...
class AbbreviationPdfTests(unittest.TestCase):
    def test_bold_abbreviation_rows_are_converted_and_ambiguity_is_preserved(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "terim_etmeni.abbreviation_pdf.pdfplumber.open",
